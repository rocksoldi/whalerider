...
[Open the complete EMA crossover file](Site/src/strategies/emacrossover.trade-plan.yaml)
...
| --- | --- | --- | --- | --- |
| **01** | [EMA crossover](Site/src/strategies/emacrossover.trade-plan.yaml) | Simple | Technical | Daily indicators, signals, risk, and direct entry/exit criteria. |
| **02** | [Breadth recovery](Site/src/strategies/breadthrecovery.trade-plan.yaml) | Intermediate | Technical + breadth | A sequential recovery state machine with an abort path. |
| **03** | [Quality value](Site/src/strategies/qualityvalue.trade-plan.yaml) | Advanced | Fundamentals + technical | Valuation, profitability, debt, liquidity, and a long-term trend filter. |
| **04** | [Insider conviction](Site/src/strategies/insidergrowth.trade-plan.yaml) | Advanced | Insiders + economy + technical | Insider accumulation, macro conditions, and price trend in one strategy. |
