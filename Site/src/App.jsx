...
const strategyExamples = [
  {
    ...
    label: "EMA crossover",
    title: "Momentum",
    description: "A long-only trend strategy that enters when the fast average crosses above the slow average and exits when the relationship reverses.",
    tags: ["Long", "Daily", "SP500"],
    file: "momentum.trade-plan.yaml",
    code: [
      "NAME: MOMENTUM",
      "SIDE: LONG",
      "RISK:",
  ...
  },
  {
    ...
    description: "Tracks price around monthly S2 support and waits for a confirmed transition before entering the NASDAQ 100 universe.",
    tags: ["Long", "15 min", "NASDAQ100"],
    file: "support-reclaim.trade-plan.yaml",
    code: [
      "NAME: SUPPORT_RECLAIM",
      "SIDE: LONG",
      "RISK:",
      "  HOLDING_MAX_PERIOD: 240D",
      "  ATR_INTERVAL: DAY",
      "  ATR_LOOKBACK: 14",
      "  STOP_LOSS_ATR: 3",
      "  TAKE_PROFIT_ATR: 1.2",
  ...
  },
  {
    ...
    title: "Three-red reversal",
    description: "Detects a three-session bearish sequence and expresses the setup as a named signal that can be compiled and tested.",
    tags: ["Long", "Daily", "DOW30"],
    file: "three-reds.trade-plan.yaml",
    code: [
      "NAME: THREE_RED_REVERSAL",
      "SIDE: LONG",
      "RISK:",
      ...
      "          AGGREGATION: SUM",
      "SIGNALS:",
      "  - NAME: THREE_FULL_REDS",
      "    IS: REDS_ACCUMULATION == 3.0",
      "CRITERIA:",
      "  ENTER:",
      "    IF: THREE_FULL_REDS",
    ].join("\n"),
  },
  {
    ...
    label: "Fundamentals",
    title: "Quality value",
    description: "Selects profitable large-cap companies with a reasonable P/E ratio and controlled debt, then exits when the fundamentals weaken.",
    tags: ["Long", "Fundamentals", "SP500"],
    file: "quality-value.trade-plan.yaml",
    code: [
      "NAME: QUALITY_VALUE",
      "SIDE: LONG",
      "RISK:",
      ...
      "  - NAME: NET_MARGIN",
      "    DOMAIN: RATIO",
      "    MEASUREMENT: NetProfitMargin",
      "  - NAME: DEBT_TO_EQUITY",
      "    DOMAIN: RATIO",
      "    MEASUREMENT: DebtToEquityRatio",
      "  - NAME: MARKET_CAP",
      "    DOMAIN: MARKET_CAP",
      "    MEASUREMENT: MarketCap",
      "SIGNALS:",
      "  - NAME: FAIR_VALUE",
      "    IS: PE_RATIO > 0 AND PE_RATIO < 20",
      "  - NAME: QUALITY",
      "    IS: NET_MARGIN > 0.10 AND DEBT_TO_EQUITY < 1",
      "  - NAME: LARGE_CAP",
      "    IS: MARKET_CAP > 10000000000",
      "  - NAME: FUNDAMENTALS_WEAKEN",
      "    IS: NET_MARGIN < 0.05 OR DEBT_TO_EQUITY > 1.5",
      "CRITERIA:",
      "  ENTER:",
      "    IF: FAIR_VALUE AND QUALITY AND LARGE_CAP",
      "  EXIT:",
      "    IF: FUNDAMENTALS_WEAKEN",
    ].join("\n"),
  },
];
        ...
        <section className="hero section-frame">
          <div className="hero-copy">
            ...
            <p className="hero-lede">
              Define a strategy in YAML, compile it into a .wr artifact, and run the same artifact in simulation or live trading.
            </p>
          ...
          <div className="hero-visual" aria-label="WhaleRider extension running in Visual Studio Code">
            <div className="vscode-window">
              <div className="vscode-titlebar">
                ...
                <span className="vscode-title">momentum.trade-plan.yaml — WhaleRider — Visual Studio Code</span>
                <div className="vscode-controls" aria-hidden="true"><span>—</span><span>□</span><span>×</span></div>
              </div>
              <div className="vscode-tabbar"><span className="is-active"><i /> momentum.trade-plan.yaml <b>×</b></span></div>
              <div className="vscode-editor-view">
                <div className="vscode-code" aria-label="Complete momentum strategy YAML example">
